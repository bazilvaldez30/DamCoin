      ...
      <div className="container mx-auto px-4 relative">
            ...
            <div className="max-w-2xl mx-auto">
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h4 className="font-semibold text-xl text-foreground">{distribution[0].label}</h4>
                  <span
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-foreground font-medium text-lg">{distribution[0].amount} $DAM</span>
                </div>
                ...
                <p className="text-sm text-muted-foreground mt-4 text-center">
                  Fair launch on Pump.fun - No team allocation, no presale, 100% community-owned
                </p>
              </motion.div>
            </div>
          </Card>
              ...
              <ul className="space-y-4">
                {utilities.map((utility, index) => (
                  ...
                  >
                    ...
                    <span className="text-muted-foreground leading-relaxed">{utility}</span>
                  </motion.li>
                ))}
              </ul>
            </Card>
            ...
            <Card className="p-10 glass-strong hover:shadow-2xl hover:shadow-primary/10 transition-all h-full">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">No fees on purchases</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">No fees on sales</p>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="font-semibold text-foreground">Liquidity Locked</span>
                  </div>
                  <p className="text-sm text-muted-foreground">LP tokens locked for 1 year</p>
                </motion.div>
              </div>
            </Card>
          </motion.div>
        ...
        >
          <p className="text-3xl font-bold mb-3">
            ...
            with{" "}
            <span className="bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent">Attitude</span>
          </p>
          <p className="text-lg text-muted-foreground">
            Join the dam builders and build the future of AI automation, one dam at a time.
          </p>
        </motion.div>
      </div>
    </section>
