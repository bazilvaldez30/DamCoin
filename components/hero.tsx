        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="gradient-primary text-primary-foreground hover:opacity-90 font-bold text-lg px-10 py-7 shadow-2xl shadow-primary/30 transition-all hover:shadow-primary/40 hover:scale-105"
              >
                {t.hero.buyButton}
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="glass border-primary/50 text-foreground hover:bg-primary/10 font-bold text-lg px-10 py-7 hover:border-primary transition-all hover:scale-105 bg-transparent"
              >
                {t.hero.joinButton}
              </Button>
            </motion.div>
