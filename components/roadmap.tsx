      ...
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
            From meme to mission. Here's how we're building the AI automation
            revolution.
          </p>
        </motion.div>
            ...
            >
              ...
              >
                <div className='text-center mb-8'>
                  ...
                  <div className='text-sm font-semibold text-primary mb-3 tracking-wide uppercase'>
                    {phase.phase}
                  </div>
        ...
        >
          <p className='text-xl text-muted-foreground mb-4 leading-relaxed'>
            This is just the beginning. The community will shape what comes
            next.
          </p>
